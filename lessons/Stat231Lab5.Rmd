...
We'll be using the *piracy* data set from the *openintro* package. It contains data for each member of congress and money they received from lobby groups for (money_pro) and against (money_con) anti-piracy legislation. 
